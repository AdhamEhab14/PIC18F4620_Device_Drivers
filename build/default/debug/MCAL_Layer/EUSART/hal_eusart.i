...
# 58 "MCAL_Layer/EUSART/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    ...
    if(((void*)0) == _eusart_obj){
        ...
        switch(_eusart_obj->baudrate_config){
            case BAUDRATE_ASYN_8BIT_lOW_SPEED :
                ...
                TXSTAbits.BRGH = 0;
                BAUDCONbits.BRG16 = 0;
                baud_rate_temp = ((4000000UL / (float)(_eusart_obj->baudrate)) / 64) - 1;
                break;
            case BAUDRATE_ASYN_8BIT_HIGH_SPEED :
                TXSTAbits.SYNC = 0;
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 0;
                baud_rate_temp = ((4000000UL / (float)(_eusart_obj->baudrate)) / 16) - 1;
                break;
            ...
            case BAUDRATE_ASYN_16BIT_HIGH_SPEED :
                ...
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 1;
                baud_rate_temp = ((4000000UL / (float)(_eusart_obj->baudrate)) / 4) - 1;
                break;
