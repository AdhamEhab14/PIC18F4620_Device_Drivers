...
# 31 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 34 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 50 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 95 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t * config);
# 105 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t * config , direction_t * direcion_status);
# 115 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_write_logic(const pin_config_t * config , logic_t logic_status);
# 125 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_read_logic(const pin_config_t * config , logic_t *logic_status);
# 134 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t * config);
# 143 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_initialize(const pin_config_t * config);
# 155 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction);
# 165 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status);
# 175 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic);
# 185 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic);
# 194 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 145 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t * lcd , uint8 * str){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
...
# 223 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_initialize(const chr_lcd_8bit_t * lcd){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(((void*)0) == lcd){
        retVal = (Std_ReturnType)0x00;
...
# 318 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t * lcd , uint8 row , uint8 column ,uint8 data){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(((void*)0) == lcd){
        retVal = (Std_ReturnType)0x00;
...
# 389 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t * lcd , uint8 row , uint8 column ,
                                            const uint8 _chr[] , uint8 mem_pos){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(((void*)0) == lcd){
...
# 420 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value , uint8 *str){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    uint8 temp_str[4] = {0};
...
# 476 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint32_to_string(uint32 value , uint8 *str){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    uint8 temp_str[11] = {0};
    uint8 data_counter = 0;
...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t * lcd , uint8 row , uint8 column){
    ...
    if(((void*)0) == lcd){
        ...
        column--;
        switch(row){
            case 1 : retVal = lcd_4bit_send_command(lcd , (0x80 + column)); break;
            case 2 : retVal = lcd_4bit_send_command(lcd , (0xc0 + column)); break;
            case 3 : retVal = lcd_4bit_send_command(lcd , (0x94 + column)); break;
            case 4 : retVal = lcd_4bit_send_command(lcd , (0xd4 + column)); break;
            default : ;
        }
        retVal = (Std_ReturnType)0x01;
    }
...
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t * lcd , uint8 row , uint8 column){
    ...
    if(((void*)0) == lcd){
        ...
        column--;
        switch(row){
            case 1 : retVal = lcd_8bit_send_command(lcd , (0x80 + column)); break;
            case 2 : retVal = lcd_8bit_send_command(lcd , (0xc0 + column)); break;
            case 3 : retVal = lcd_8bit_send_command(lcd , (0x94 + column)); break;
            case 4 : retVal = lcd_8bit_send_command(lcd , (0xd4 + column)); break;
            default : ;
        }
        retVal = (Std_ReturnType)0x01;
    }
