...
# 31 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 50 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 95 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t * config);
# 105 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t * config , direction_t * direcion_status);
# 115 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_write_logic(const pin_config_t * config , logic_t logic_status);
# 125 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_read_logic(const pin_config_t * config , logic_t *logic_status);
# 134 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t * config);
# 143 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_initialize(const pin_config_t * config);
# 155 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction);
# 165 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status);
# 175 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic);
# 185 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic);
# 194 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
...
Std_ReturnType dc_motor_initialize(const dc_motor_t * motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_pin_initialize(&(motor->dc_motor_pin[0x00U]));
        gpio_pin_initialize(&(motor->dc_motor_pin[0x01U]));
...
Std_ReturnType dc_motor_move_right(const dc_motor_t * motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_pin_write_logic(&(motor->dc_motor_pin[0x00U]) , GPIO_HIGH);
        gpio_pin_write_logic(&(motor->dc_motor_pin[0x01U]) , GPIO_LOW);
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
...
Std_ReturnType dc_motor_move_left(const dc_motor_t * motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_pin_write_logic(&(motor->dc_motor_pin[0x00U]) , GPIO_LOW);
        gpio_pin_write_logic(&(motor->dc_motor_pin[0x01U]) , GPIO_HIGH);
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
