...
- [`stm32/nvic/`](stm32/nvic/) — Nested Vectored Interrupt Controller driver (`CortexM3_Core_NVIC`), plus the System Control Block (`CortexM3_Core_SCB`) it depends on for priority grouping.
- More peripherals (RCC, SysTick, DMA, GPIO, Flash) are being added as they're finished.
