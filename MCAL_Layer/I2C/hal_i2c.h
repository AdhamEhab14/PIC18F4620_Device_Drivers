 ...
 * Author: Adham
 *
 * Created on September 19, 2024, 5:38 PM
 */
...
/* Clock Stretch */
#define I2C_CLOCK_STRETCH_ENABLE_CFG()          (SSPCON1bits.CKP = 0)
#define I2C_CLOCK_STRETCH_DISABLE_CFG()         (SSPCON1bits.CKP = 1)
 ...
 * @param _i2c_obj pointer to the I2C configurations module
...
/**
 * @brief Master Send Repeated Start Condition
 * @param _i2c_obj pointer to the I2C configurations module
 * @return status of the function
 *          (E_OK) : the function done successfully
 *          (E_NOT_OK) : the function has issue to perform this action
...
/**
 * @brief Write Data while blocking the CPU till the data is written
 * @param _i2c_obj pointer to the I2C configurations module
 * @param _i2c_data the data to be written 
 * @return status of the function
 *          (E_OK) : the function done successfully
 *          (E_NOT_OK) : the function has issue to perform this action
 */
...
/**
 * @brief Read Data while blocking the CPU till the data is read
 * @param _i2c_obj pointer to the I2C configurations module
 * @param _ack Acknowledge signal (OK , NOT_OK)
 * @param _i2c_data pointer to the data that is being read
 * @return status of the function
 *          (E_OK) : the function done successfully
 *          (E_NOT_OK) : the function has issue to perform this action
 */
...
/**
 * @brief Write Data without blocking the CPU
 * @param _i2c_obj pointer to the I2C configurations module
 * @param _i2c_data the data to be written 
 * @return status of the function
 *          (E_OK) : the function done successfully
...
/**
 * @brief Read Data without blocking the CPU
 * @param _i2c_obj pointer to the I2C configurations module
 * @param _ack Acknowledge signal (OK , NOT_OK)
 * @param _i2c_data pointer to the data that is being read
 * @return status of the function
